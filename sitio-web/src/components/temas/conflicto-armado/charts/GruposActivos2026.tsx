...
const grupos = [
  ...
  { grupo: "EMC (Mordisco)", integrantes: 4019, crecimiento: 23, tipo: "Disidencia FARC" },
  { grupo: "EMBF (Calarcá)", integrantes: 2958, crecimiento: 22, tipo: "Disidencia FARC" },
  { grupo: "CNEB", integrantes: 2089, crecimiento: 25, tipo: "Disidencia FARC" },
